...
const dictionary: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "chat.sources": "Fuentes analizadas",
  ...
  en: {
    ...
    "chat.web_pages": "web sources",
    "chat.thinking": "Thinking...",
    "chat.no_image": "No image available",
    "chat.no_video": "No video available",
    "chat.google_search_hint": "Try searching on Google with these terms:",
    "chat.sources": "Analyzed sources",
