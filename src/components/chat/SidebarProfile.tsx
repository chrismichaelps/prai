              ...
              >
                {activeTab === 'main' ? (
                  ...
                  >
                    ...
                    <button className="w-full flex items-center gap-3 p-2.5 rounded-xl hover:bg-white/5 text-white/80 hover:text-white transition-all text-sm">
                      <HelpCircle className="w-4 h-4" />
                      <span>{t('auth.help_center')}</span>
                    </button>
                    <button
                      onClick={() => {
                        setIsPopoverOpen(false)
