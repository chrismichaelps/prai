...
### [Semantic Hash]
Root Redux store combining chat, auth, issues, and UI slice reducers. Exported singleton and types consumed by Redux Effect service.

### [Linkage]
- **Upstream:** `chatSlice`, `authSlice`, `issuesSlice`, `uiSlice`
